...
# PEP8
# NO PYTHON CLASSES
# 7 - 10 functions (exactly) - each function max 20 lines of code
# use at least one function from functional programming (filter, lambda, map)
# read and write data to/from a file
# average across students in course
# average across courses for student
# average across all students in school
# average across all courses in school
# 20 students
# 6 courses
# schools
# EXTRA : type hints
